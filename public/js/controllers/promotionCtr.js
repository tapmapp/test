whola.controller('promotionCtr', function($scope, $compile, $http, $filter) {
	...
	$scope.addProduct = function(){
		var compiledHTML = $compile("<div add-Product></div>")($scope);
		$('#addProduct').append(compiledHTML);
	}

	$scope.showChart = function(){
		var compiledHTML = $compile("<div sales-Chart></div>")($scope);
		$('#salesChart').append(compiledHTML);
	}
	...
	$scope.selectProduct = function(product) {
		...
		var compiledHTML = $compile("<div product-Detail></div>")($scope);
		$('#productDetail').html('');
		$('#productDetail').append(compiledHTML);
	};
	/* END PRODUCTS */
...
whola.directive('addProduct',function(){
	return {
		templateUrl: '/partials/merchants/add-product.ejs'
	}
});

whola.directive('productDetail',function(){
	return {
		templateUrl: '/partials/merchants/product-detail.ejs'
	}
});

whola.directive('salesChart', function(){
	return {
		templateUrl: '/partials/charts/sales-chart.ejs'
	}
});